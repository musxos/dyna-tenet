    ...
    <>
      <div className="flex flex-col gap-3">
        <div className="flex lg:flex-row flex-col gap-3">
          <div className="shrink-0 grow lg:w-96">
        ...
        <div className="flex lg:flex-row flex-col gap-3">
          <div className="flex flex-col grow w-96 shrink-0 h-max">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="rounded-custom bg-secondary border border-border px-6 py-8 w-full xl:w-96 h-max"
            >
          ...
          {clientWidth > 1024 && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="rounded-custom border border-border bg-secondary overflow-x-auto px-6 py-8 grow"
            >
